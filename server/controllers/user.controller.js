import { sendEmailWithNodemailer } from "../config/sendEmail.js";
...
export async function registerUserController(request, response) {
  try {
    ...
    const verifyEmail = await sendEmailWithNodemailer({
      sendTo: email,
    ...
    return response.json({
      message:
        "User register successfully. Please check your email to verify email",
      error: false,
      success: true,
      data: save,
    });
...
export async function loginController(request, response) {
  try {
    ...
    const cookiesOption = {
      ...
      secure: true, // cookie work on https
      sameSite: "None", // csrf
    };
