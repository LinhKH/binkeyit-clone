    ...
    <section className="">
      <div className="p-2  bg-white shadow-md flex items-center justify-between gap-4">
        ...
        <Link
          ...
          className="text-sm border border-primary-200 hover:bg-primary-200 px-3 py-2 rounded"
        >
          <button className="text-sm border border-primary-200 hover:bg-primary-200 px-3 py-2 rounded">
            Add Product
          </button>
        </Link>
      </div>
