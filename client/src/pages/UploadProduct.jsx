            ...
            <div>
              <select
                ...
                onChange={(e) => {
                  ...
                  if (
                    category &&
                    !data.category.find((el) => el._id === value)
                  ) {
                    setData((prev) => ({
                      ...prev,
              ...
              >
                ...
                {allCategory.map((cate) => {
                  return (
                    <option
                      disabled={data.category.some(
                        (category) => category._id === cate._id
                      )}
                      value={cate?._id}
                      key={cate._id}
                    >
                      {cate.name}
                      {data.category.includes(cate._id) ? true : false}
                    </option>
                  );
                })}
              </select>
              <div
                className={`flex flex-wrap gap-2 p-1 rounded-lg ${
                  data.category.length > 0 ? "bg-orange-200" : ""
                }`}
              >
                {data.category.map((cate, index) => {
                  return (
                    <div
                      key={cate._id + index + "productsection"}
                      className="text-xs flex items-center gap-1 bg-blue-50 rounded-lg"
                    >
                      <p className="p-1">{cate.name}</p>
                      <div
            ...
            <div>
              <select
                ...
                onChange={(e) => {
                  ...
                  if (
                    subCategory &&
                    !data.subCategory.find((el) => el._id === value)
                  ) {
                    setData((prev) => ({
                      ...prev,
              ...
              >
                ...
                {allSubCategory.map((c, index) => {
                  return (
                    <option
                      disabled={data.subCategory.some(
                        (subcategory) => subcategory._id === c._id
                      )}
                      value={c?._id}
                      key={index}
                    >
              ...
              <div
                className={`flex flex-wrap gap-2 p-1 rounded-lg ${
                  data.subCategory.length > 0 ? "bg-orange-200" : ""
                }`}
              >
